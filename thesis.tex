...
\usepackage{hyperref}%% To use hyperlinks to all citations
\hypersetup{
...
\vspace{10pt}
{\Large {Dr. M. S. Bhat \hspace{.5in} Mr. Narendran Kumaragurunathan}} \\
\hspace{-0.2in}Professor \hspace{1.50in} SMTS Design Engineer\\
\hspace{-0.45in}Dept of E \& C, NITK \hspace{1.65in} AMD India Pvt. Ltd\\
\vspace{-0.05in}
%\begin{figure*}[htp]
%\hspace{0.6in} \subfigure{\includegraphics[height=0.85in,width=0.85in]{./figures/Surthkal_logo.eps}}\hspace{2.1in}
%   \subfigure{\includegraphics[height=0.6in,width=1.2in]{./figures/amd_logo.eps}}
%\end{figure*}
